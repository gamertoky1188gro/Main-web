export const PrivecyPolicy = () => {
    return (
        <div id="" style={{marginTop: "5%", width: "60%", border: "none", margin: "none", fontSize: "22.5px", fontWeight: "bolder" }} className="card mx-auto">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to CyberStudio, accessible from <a href="http://localhost:5173/"
                                                                                          rel="external nofollow noopener"
                                                                                          target="_blank">http://localhost:5173/</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: tokyintelligentgamer@gmail.com</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="http://localhost:5173/contact"
                                                                rel="external nofollow noopener"
                                                                target="_blank">http://localhost:5173/contact</a></p>
                </li>
            </ul>
        </div>
    )
